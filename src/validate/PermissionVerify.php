...
class PermissionVerify extends Validate
{
    protected $rule = [
        'name' => 'require|max:50|unique:peter\permission\rbac\model\permission,name',
        'path' => 'require|max:200|unique:peter\permission\rbac\model\permission,path',
